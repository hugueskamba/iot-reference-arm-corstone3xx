...
protected:
    OUT * getWriteBuffer()
    {
        return mDst.getWriteBuffer( outputSize );
    }

    IN * getReadBuffer()
    {
        return mSrc.getReadBuffer( inputSize );
    }
...
protected:
    OUT1 * getWriteBuffer1()
    {
        return mDst1.getWriteBuffer( output1Size );
    }

    OUT2 * getWriteBuffer2()
    {
        return mDst2.getWriteBuffer( output2Size );
    }
...
protected:
    ...
    IN1 * getReadBuffer1()
    {
        return mSrc1.getReadBuffer( input1Size );
    }

    IN2 * getReadBuffer2()
    {
        return mSrc2.getReadBuffer( input2Size );
    }
